...
{
  _conversionDelay = 625;                         // default delay usecs
  _config[0]     = 0b00000001;                    // config register
  _config[1]     = 0b00000100;                    // byte1 os=0, mux=000, fsr=010, mode=0
...
void Ads1015_esp8266::selectRate(uint8_t dr)
{
  ...
  {
    case (0):
      _conversionDelay = 7813;
      break;
    case (1):
      _conversionDelay = 4000;
      break;
    case (2):
      _conversionDelay = 2041;
      break;
    case (3):
      _conversionDelay = 1087;
      break;
    case (4):
      _conversionDelay = 625;
      break;
    case (5):
      _conversionDelay = 417;
      break;
    case (6):
      _conversionDelay = 304;
      break;
  }
}
